...
// For MAMP
defined('SITE_ROOT') ? null : define('SITE_ROOT', '/Applications/MAMP/htdocs/myPersonalProjects/CuteNinjar/');
...
defined('LOCAL') ? null : define('LOCAL', 'http://localhost/myPersonalProjects/CuteNinjar/');
